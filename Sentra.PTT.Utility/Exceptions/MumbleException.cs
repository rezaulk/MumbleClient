...
namespace Sentra.PTT.Utility.Exceptions
{
    public class MumbleException : Exception
    {
        ...
        public MumbleException(string messageFormat, params object[] args)
        ...
        public MumbleException(string message, Exception innerException)
